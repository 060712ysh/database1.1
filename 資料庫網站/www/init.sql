-- 資料庫網頁設計 初始化 SQL 腳本
-- 最終極修正版：包含完整架構 (系統設定、操作日誌、節次排課等) 
-- ✨已將帳號格式全面重構為學號(sXXXXX)與教師代號(tXXXXX)✨
...
-- 🚀 修正：插入測試帳號 (密碼皆為 123456，帳號依序改為 t00001、s00001 格式)
INSERT INTO Users (id, username, password_hash, role) VALUES
(1, 'admin', '$2y$10$N9qo8uLOickgx2ZMRZoHKe6m95iXt/tBKkjlzYF5ZlIzGTlqx7Upu', 'Admin'),
(2, 't00001', '$2y$10$N9qo8uLOickgx2ZMRZoHKe6m95iXt/tBKkjlzYF5ZlIzGTlqx7Upu', 'Teacher'),
(3, 't00002', '$2y$10$N9qo8uLOickgx2ZMRZoHKe6m95iXt/tBKkjlzYF5ZlIzGTlqx7Upu', 'Teacher'),
(4, 't00003', '$2y$10$N9qo8uLOickgx2ZMRZoHKe6m95iXt/tBKkjlzYF5ZlIzGTlqx7Upu', 'Teacher'),
(5, 's00001', '$2y$10$N9qo8uLOickgx2ZMRZoHKe6m95iXt/tBKkjlzYF5ZlIzGTlqx7Upu', 'Student'),
(6, 's00002', '$2y$10$N9qo8uLOickgx2ZMRZoHKe6m95iXt/tBKkjlzYF5ZlIzGTlqx7Upu', 'Student'),
(7, 's00003', '$2y$10$N9qo8uLOickgx2ZMRZoHKe6m95iXt/tBKkjlzYF5ZlIzGTlqx7Upu', 'Student');
...
(2, 3, '林教授', '副教授', '02-23456789 ext 1235', 'lin.db@example.edu.tw', '每週 Wednesdays 10:00 - 12:00', '資料探勘實驗室 (Data Mining Lab)', '專注於巨量資料分析與推薦系統。', '112學年度 資料庫系統', NULL),
...
(2, '發表期刊論文', '基於圖神奈網絡之推薦系統', '王五、林教授', '2023-08'),
(3, '會議論文', '快速排序演算法之效能改良', '陳教授', '2024-01');

-- =====================================================
-- 🌟 修正：空間預約紀錄預設資料 (Reservations - 對齊 sXXXXX 學號)
-- =====================================================
INSERT INTO Reservations (student_id, room_name, purpose, reserve_date, start_period, end_period, status) VALUES
('s00001', '討論室 101 (4人)', '專題小組討論與進度報告', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 3, 5, 'Approved'),
('s00002', '討論室 103 (6人)', '演算法期中考複習讀書會', DATE_ADD(CURDATE(), INTERVAL 3 DAY), 7, 8, 'Pending'),
('s00003', '討論室 201 (4人)', '系學會活動規劃會議', DATE_ADD(CURDATE(), INTERVAL 5 DAY), 10, 12, 'Pending'),
('s00001', '討論室 105 (8人)', '黑客松競賽賽前準備', DATE_SUB(CURDATE(), INTERVAL 1 DAY), 2, 4, 'Rejected');
...
-- 🚀 修正：選課正式紀錄表格 (Enrollments - 對齊 sXXXXX 學號)
...
('s00002', 1, 70, 65, 80, 72),
('s00001', 3, NULL, 85, NULL, NULL),
('s00003', 2, 90, 88, 92, 90);

-- 🚀 修正：選課申請流動紀錄 (CourseRequests - 對齊 sXXXXX 學號)
INSERT INTO CourseRequests (student_id, course_id, action, status) VALUES
('s00003', 1, 'Add', 'Pending'),
('s00002', 1, 'Drop', 'Pending');